  ...
  try {
    ...
    const templates = await prisma.productionCurveTemplate.findMany({
      ...
      include: {
        ...
        variety: { select: { id: true, name: true, baseTemp: true, gdhWinteredFlowerSummer: true, gdhWinteredFruitSummer: true, gdhPlantedFlowerSummer: true, gdhPlantedFruitSummer: true, gdhLcFlowerSummer: true, gdhLcFruitSummer: true, gdhFruitAutumn: true } },
