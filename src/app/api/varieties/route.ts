  ...
  try {
    ...
    const newVariety = await prisma.variety.create({
      data: {
        ...
        gdhWinteredFlower: variety.gdhWinteredFlower != null ? parseInt(variety.gdhWinteredFlower) : null,
        gdhWinteredFruit: variety.gdhWinteredFruit != null ? parseInt(variety.gdhWinteredFruit) : null,
        gdhLcFlower: variety.gdhLcFlower != null ? parseInt(variety.gdhLcFlower) : null,
        gdhLcFruit: variety.gdhLcFruit != null ? parseInt(variety.gdhLcFruit) : null,
        gdhAutumnFlower: variety.gdhAutumnFlower != null ? parseInt(variety.gdhAutumnFlower) : null,
        gdhAutumnFruit: variety.gdhAutumnFruit != null ? parseInt(variety.gdhAutumnFruit) : null,
