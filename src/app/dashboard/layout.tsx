...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Sidebar - Desktop */}
      <aside className="fixed left-0 top-0 z-40 h-screen w-64 bg-gradient-to-b from-green-600 to-green-700 hidden lg:block">
        {/* Logo */}
      ...
      {mobileMenuOpen && (
        <>
          ...
          />
          <aside className="fixed left-0 top-14 z-50 h-[calc(100vh-3.5rem)] w-64 bg-gradient-to-b from-green-600 to-green-700 lg:hidden">
            <nav className="p-3 space-y-1">
              {menuItems.map((item) => {
                const isActive = pathname === item.href
                return (
