...
export default function PlantationPage() {
  ...
  const [sectionForm, setSectionForm] = useState({ name: '', metersLength: 100, potsPerMeter: 2, shootsPerPot: 2, potsOverride: '' as string | number, plantingYear: new Date().getFullYear(), productionYear: 1, plantMaterialType: 'SMALL_POT', plantSource: '', varietyId: '', yieldSummerPerShoot: '' as string | number, yieldAutumnPerShoot: '' as string | number, gdhSummer: 20000, gdhAutumn: 25000, winteredInTunnel: false, plantingDate: '', autumnShootDate: '' })
  ...
  const resetSection = () => { setSectionForm({ name: '', metersLength: 100, potsPerMeter: 2, shootsPerPot: 2, potsOverride: '', plantingYear: new Date().getFullYear(), productionYear: 1, plantMaterialType: 'SMALL_POT', plantSource: '', varietyId: '', yieldSummerPerShoot: '', yieldAutumnPerShoot: '', gdhSummer: 20000, gdhAutumn: 25000, winteredInTunnel: false, plantingDate: '', autumnShootDate: '' }); setEditingSection(null); setShowSectionForm(null) }
